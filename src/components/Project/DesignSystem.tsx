...
export default function DesignSystem() {
  ...
  return (
    <div className="flex flex-col gap-24">π
      ...
      <div className="flex flex-col gap-12">
        ...
        <p className="md:text-2xl text-lg">Implemented Atomic Design principles. Worked backwards from existing UI to
          ensure consistency with current product. Collaborated with product and development teams to align with live
          implementation
        </p>
