    ...
    <Link href={`/archive/${slug}`} className="w-full">
      <div className="archive-slat group cursor-pointer transition-all duration-200 ease-in-out hover:bg-stone-950">
        <div className="flex justify-between items-center relative py-4 px-2 ">
          <span
            className="text-small-clamp md:text-2xl group-hover:font-bold text-stone-950 group-hover:text-slate-50 group-hover:translate-x-1 transition-all duration-300">
            {title}
          </span>
          <span
            className="text-small-clamp group-hover:font-bold text-stone-950 group-hover:text-slate-50 group-hover:-translate-x-1 transition-all duration-300">
            Full Case
          </span>
