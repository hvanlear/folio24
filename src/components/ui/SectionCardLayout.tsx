  ...
  return (
    <div className="flex w-full justify-center relative isolate">
      <div className={cn("w-full flex items-center flex-col", innerClassName)}>
        <motion.div className="-z-10 pl-4 w-full" {...headingMotionProps}>
        ...
        <section className="w-full">
          <div
            className={cn(
              "relative z-10 border-x-2 border-t-2 border-stone-600 rounded-tl-[5rem] rounded-tr-[5rem] w-full flex flex-col justify-center",
